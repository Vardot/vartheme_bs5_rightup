...
```twig
{% embed 'vartheme_bs5_rightup:accordion-block' with {
...
- When `accordion_content` is empty, a placeholder body is rendered via the `vartheme_bs5_rightup:text` component.
