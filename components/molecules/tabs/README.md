...
```twig
{% include 'vartheme_bs5_rightup:tabs' with {
  shape: 'pills',
...
- The component depends on the `vartheme_bs5_rightup/bs-tab-script` library (declared via `libraryOverrides`) for tab toggling behavior.
