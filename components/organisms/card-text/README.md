...
```twig
{% embed 'vartheme_bs5_rightup:card-text' with {
  card_border: true,
...
- The icon is rendered via the `vartheme_bs5_rightup:image` component using `object-fit-contain` and `w-auto`; SVGs are recommended.
