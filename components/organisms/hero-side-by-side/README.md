...
- `heading`: main title text, rendered via `vartheme_bs5_rightup:heading`
...
- `image`: main image object shown in the second column, rendered via `vartheme_bs5_rightup:image`
...
```twig
{% include 'vartheme_bs5_rightup:hero-side-by-side' with {
