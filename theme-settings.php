 ...
 */
function vartheme_bs5_rightup_form_system_theme_settings_alter(&$form, FormStateInterface $form_state, $form_id = NULL) {
  ...
  foreach ($vartheme_bs5_rightup_contained_regions as $contained_region_name => $contained_region_title) {
